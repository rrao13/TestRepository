...
public class MySecondWebDriverTest {
  ...
  public void testMySecondWebDriver() throws Exception {
    ...
    driver.findElement(By.cssSelector("#username")).sendKeys("ramya1309");
    driver.findElement(By.id("password")).clear();
   // driver.findElement(By.id("password")).sendKeys("Ramya3018");
    driver.findElement(By.xpath(".//*[@id='password']")).sendKeys("Ramya3018");
